       ...
       //enviar data
        case 'POST':
            ...
            try {
                ...
                $sql = 'SELECT id,correo,pass,nombre,apellido FROM usuario  WHERE correo="'.$username.'" AND pass ="'.$password.'"';
                ...
                if($row){
                    ...
                    if($row['correo'] == $_POST['username'] and $row['pass'] == $password){
                        ...
                        if($token){
                            ...
                            $response['user'] = $row['nombre'].' '.$row['apellido'];
