            ...
            if(isset($_GET['id'])){
                ...
                //Instaciamos la clase para genrear el documento pdf
                   ...
                   // $y_axis_initial = 0;
                    ...
                    $pdf->Cell(40,6,'',0,0,'C');
                    $pdf->Cell(90,6,'Lista de salidas del dia',1,0,'C');
                    ...
                    while($row = mysqli_fetch_assoc($result))
                    {
                        ...
                        $pdf->Cell(40,8,utf8_decode($motivo),1,0,'C',0);

                        $pdf->Cell(50,8,utf8_decode($cantidad),1,0,'C',0);

                        $pdf->Cell(60,8,utf8_decode($fecha),1,0,'C',0);
